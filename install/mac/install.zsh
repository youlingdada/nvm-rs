...
# 导出环境变量到用户目录
echo "export NVM_HOME=$NVM_HOME" >> "$HOME/.zprofile"
echo "export NVM_SYMLINK=$NVM_SYMLINK" >> "$HOME/.zprofile"
echo "export PATH=$PATH:$NVM_HOME:$NVM_SYMLINK/bin" >> "$HOME/.zprofile"
